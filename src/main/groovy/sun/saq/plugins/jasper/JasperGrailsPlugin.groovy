package sun.saq.plugins.jasper
...
class JasperGrailsPlugin extends Plugin {
    ...
    def description = '''
    Adds easy support for launching sun.saq.jasper reports from GSP pages.
    After installing, run your application and request (app-url)/sun.saq.jasper/demo for a demonstration and instructions.
    '''
    def profiles = ['web']

    def documentation = "http://www.grails.org/plugin/sun.saq.jasper"
    def license = "APACHE"
    ...
    def issueManagement = [system: "JIRA", url: "https://github.com/puneetbehl/grails-sun.saq.jasper/issues"]
    def scm = [url: "https://github.com/puneetbehl/grails-sun.saq.jasper"]
